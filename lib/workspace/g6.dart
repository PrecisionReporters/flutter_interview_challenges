...
class _NthPrimeState extends State<NthPrime> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final result = nthPrime(_n);
      setState(() {
        // This is an arbitrary number to increase the nth prime by.
        // Please do not change this value. It is not part of the challenge.
        _n += 253;
        _nthPrime = result;
      });
    });
...
// Please do not modify the following widget. It is functionally correct and
